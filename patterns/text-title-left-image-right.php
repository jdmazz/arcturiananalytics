 ...
 * Slug: arcturiananalytics/text-title-left-image-right
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:50%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<p class="has-heading-font-family has-x-large-font-size" style="line-height:1.2"><?php echo esc_html_x( 'Arcturian Analytics is a leader in merging machine learning with electrocatalysis, an innovative and critical approach in the CO2 capture industry. Our team has developed proprietary algorithms and optimized hardware that give us a strong competitive edge, enabling our systems to adapt intelligently across diverse CO2 capture scenarios. 
', 'Headline for the About pattern', 'arcturiananalytics' ); ?></p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-group">
					...
					<p><?php echo esc_html_x( 'Join Arcturian Analytics on the frontier of intelligent CO2 capture solutions.', 'Description for the About pattern', 'arcturiananalytics' ); ?></p>
					<!-- /wp:paragraph -->
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button">
							<a class="wp-block-button__link wp-element-button"><?php echo esc_html_x( 'About us', 'Call to Action button text', 'arcturiananalytics' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<figure class="wp-block-image size-large is-style-rounded">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/mse-cellphone.webp" alt="<?php esc_attr_e( 'A material scientist analyzing molecules.', 'arcturiananalytics' ); ?>" style="aspect-ratio:3/4;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
